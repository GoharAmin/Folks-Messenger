...
import codegradients.com.chatapp.helper_classes.ScreenshotPrevention.service.ScreenShotContentObserver;
...
public class BitmapManipulationUtil {
    ...
    public static Bitmap getOverlayBitmap2(Context context, Bitmap bitmap, String text) {
        ...
        StaticLayout mTextLayout = new StaticLayout(text, mTextPaint, canvas.getWidth() - BitmapManipulationUtil.dpToPx(87), Layout.Alignment.ALIGN_CENTER, 1.0f, 0.3f, true);
        canvas.save();

        float textX = (canvas.getWidth() / 2) - (mTextLayout.getWidth() / 2);
        float textY = result.getHeight() - BitmapManipulationUtil.dpToPx(72);
